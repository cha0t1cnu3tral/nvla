...
- Native `NVDA+T`, `NVDA+Tab`, `NVDA+B`, `NVDA+H`, and `NVDA+Q` preview
  commands for the active window title, focused object, a bounded active-tree
  read-through, command help, and clean preview shutdown.
