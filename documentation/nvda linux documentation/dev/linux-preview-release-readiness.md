...
- Native `NVDA+1`, `NVDA+F2`, `NVDA+F12`, `NVDA+T`, `NVDA+Tab`, `NVDA+B`,
  `NVDA+H`, and `NVDA+Q` preview commands for input help, passing the next key
  sequence through, time and date, the active window title, focused object, a
